...
%\begin{frame}{Experiment: making attribute embedder 1 layer deeper}
%    \begin{figure}
%        \centering
%        \includegraphics[width=\textwidth]{images/deep/unseen}
%    \end{figure}
%\end{frame}
...
%    \begin{figure}
%        \centering
%        \includegraphics[width=\textwidth]{images/deep/seen}
%    \end{figure}
%\end{frame}
...
%    \begin{figure}
%        \centering
%        \includegraphics[width=\textwidth]{images/deep/harmonic}
%    \end{figure}
%\end{frame}


%\begin{frame}{Experiment: maybe we just overfit?}
%    \begin{figure}
%        \centering
%        \includegraphics[width=\textwidth]{images/overfit/unseen}
%    \end{figure}
%\end{frame}
...
%    \begin{figure}
%        \centering
%        \includegraphics[width=\textwidth]{images/overfit/seen}
%    \end{figure}
%\end{frame}


%\begin{frame}{Experiment: GDPP}
%    (in slack since there are 5 plots)
%    
%    Batch size: 200 (generate 10 prototypes per class, 20 classes in a task)
%\end{frame}
